...
// Pre-computed results for instant display in QueryExplorer

import type { FashionCategory } from './ecommerceSampleSchema';
...
// All sample data combined for easy import
export const ECOMMERCE_SAMPLE_DATA = {
  stats: DATASET_STATS,
...
export default ECOMMERCE_SAMPLE_DATA;
